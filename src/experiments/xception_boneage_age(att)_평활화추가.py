...
EQUALIZE  = "clahe"       # 마지막 히스토그램 평활화: "he" | "clahe" | "none"
...
CACHE_DIR = BASE_DIR / "cache_preprocessed_3" / f"{CROP_MODE}_{IMG_SIZE}_{EQUALIZE}"
CKPT_DIR  = BASE_DIR / "checkpoints_xception_3"          # 최종모델 체크포인트와 분리
