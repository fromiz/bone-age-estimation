...
# │            ▼                                                         │
# │      [F] 캐시  cache_convnext_single_v5/<PRE_TAG>/{train,val,test}/  │
# │            ▼                                                         │
...
#
# ▶ 실행: python convnexttiny_single_640x448_v5.py
...
#
# ▶ 산출물  checkpoints_convnext_single_v5/
...
#   logs/convnext_single_v5_<ts>.log   실행 로그 전체
# =========================================================================
...
RUN_STATE = LOG_DIR / "convnext_single_v5_running.json"
_WORKER_ENV = "BONEAGE_CONVNEXT_SINGLE_V5_WORKER"
...
def _spawn_detached():
    ...
    log_path = LOG_DIR / f"convnext_single_v5_{ts}.log"
...
CKPT_DIR  = BASE_DIR / "checkpoints_convnext_single_v5"
